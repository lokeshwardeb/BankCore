                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="container">
                            <div class="status">
                                <?php
                                    $controllers->enter_transfer_interface();
                                ?>
                            </div>
                        </div>
                        <div class="welcome_msg">
                            <div class="container">
                                <div class="msg page m-4 rounded-4 fs-5 fw-bold fst-italic p-4">
                                    Transfer Money From One Account To Another <span class="text-primary">Account</span>
                            ...
                            <div class="container">
                                <div class="form page m-4 p-4 rounded-4">
                                    <form action="" method="post">
                                        ...
                                        <div class="mb-3">
                                            <button type="submit" name="enter_transfer_interface" class="btn btn-outline-primary mt-4">Enter into the transfer interface</button>
                                        </div>
