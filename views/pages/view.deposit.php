                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <div class="container">
                            <div class="status">
                                <?php
                                    $controllers->enter_deposit_interface();
                                ?>
                            </div>
                        </div>
                            ...
                            <div class="container">
                                <div class="form page m-4 p-4 rounded-4">
                                    <form action="" method="post">
                                        ...
                                        <div class="mb-3">
                                            <button type="submit" name="enter_deposit_interface" class="btn btn-outline-primary mt-4">Enter into the deposit interface</button>
                                        </div>
